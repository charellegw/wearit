class TTexts {
  ...
  static const String forgotSuccessSubtitle = "We’ve sent you an email with password reset link. Please check your inbox and click the link to reset your password.";
